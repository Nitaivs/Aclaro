...
export default function DepartmentListPage() {
    ...
    /**
        ...
        * Calls the addDepartment function from DepartmentContext and manages error handling.
     ...
     * Calls the deleteDepartmentById function from DepartmentContext and manages error handling.
